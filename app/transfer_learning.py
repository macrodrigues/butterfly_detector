...
def compile_model():
    ...
    dense_layer_1 = layers.Dense(540, activation='relu')
    dense_layer_2 = layers.Dense(264, activation='relu')
    dense_layer_3 = layers.Dense(136, activation='relu')
    dense_layer_4 = layers.Dense(50, activation='relu')
